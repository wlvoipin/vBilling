...
$lang['admin_new_sip_view_username'] = 'SIP Username customer will use to login';
$lang['admin_new_sip_view_cid'] = 'Caller ID you want to send to your provider for this user. Leave as is to send as received';
$lang['admin_new_sip_view_sip_ip'] = 'SIP IP address customer will use to login using his SIP credentials';
$lang['admin_new_acl_node_view_acl_node'] = 'Customer\\\'s IP address to authorize without using SIP credentials (login/password) <br><br>Don\\\'t put domain name in here. Only IP address allowed, for \
