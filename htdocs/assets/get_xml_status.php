...
$fp = $instance->event_socket_create($instance->ESL_host, $instance->ESL_port, $instance->ESL_password);
$cmd = "api show connected_calls as xml";
$response = $instance->event_socket_request($fp, $cmd);
fclose($fp);
print $response; 
?>
