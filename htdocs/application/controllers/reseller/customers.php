...
class Customers extends CI_Controller {
	...
	function index()
	{
		...
		$config['per_page'] = '20';
		$config['base_url'] = base_url().'reseller/customers/?searchFilter='.$search.'&filter_account_num='.$filter_account_num.'&filter_company='.$filter_company.'&filter_first_name='.$filter_first_name.'&filter_type='.$filter_type.'&filter_sort='.$filter_sort.'&filter_contents='.$filter_contents.'';
		...
		$data['sub_menu']	    =	'default/sub_menu/reseller/customer_sub_menu';
		$data['main_content']	=	'reseller/customers/customers_view';
	...
	function new_customer()
	{
		...
		$data['main_menu']	    =	'default/main_menu/reseller_main_menu';
		$data['sub_menu']	    =	'default/sub_menu/reseller/customer_sub_menu';
		$data['main_content']	=	'reseller/customers/add_customer_view';
		$this->load->view('default/template',$data);
	}
	...
	function edit_customer($customer_id = '')
	{
		...
		$data['main_menu']	    =	'';
		$data['sub_menu']	    =	'';
		$data['main_content']	=	'reseller/customers/edit_customer_view';
	...
	function customer_rates($customer_id = '')
	{
		...
		$this->load->library('pagination');
		$config['per_page'] = '20';
		$config['base_url'] = base_url().'customers/customer_rates/'.$customer_id.'/?searchFilter='.$search.'&filter_start_date='.$filter_start_date.'&filter_end_date='.$filter_end_date.'&filter_rate_type='.$filter_rate_type.'&filter_display_results='.$filter_display_results.'&filter_sort='.$filter_sort.'';
		$config['page_query_string'] = TRUE;
		...
		if($customer_group_id != '' && $customer_group_id != '0')
		{
			...
			$data['count']          =   $this->customer_model->customer_rates_count($customer_group_table, $filter_start_date, $filter_end_date, $filter_rate_type);
			$data['rates']          =   $this->customer_model->customer_rates($config['per_page'], $config['uri_segment'], $customer_group_table, $filter_start_date, $filter_end_date, $filter_rate_type, $filter_sort);
		}
		else
		{
		...
		$data['main_menu']	    =	'';
		$data['sub_menu']	    =	'';
		$data['main_content']	=	'reseller/customers/rate_customer_view';
        $data['dont_show_this'] = 1;
		$this->load->view('default/template',$data);
	}
...
function customer_acl_nodes($customer_id = '')
{
	...
	$data['main_menu']	    =	'';
	$data['sub_menu']	    =	'';
	$data['main_content']	=	'reseller/customers/ip_customer_view';
    $data['dont_show_this'] = 1;
	$this->load->view('default/template',$data);
}
...
{
	if(customer_any_cell($customer_id, 'parent_id') != $this->session->userdata('customer_id') || $customer_id == '')
    {
	...
	$data['main_menu']	    =	'';
	$data['sub_menu']	    =	'';
	$data['main_content']	=	'reseller/customers/new_acl_node_view';
    $data['dont_show_this'] = 1;
	$this->load->view('default/template',$data);
}
...
function edit_acl_node($node_id = '', $customer_id = '')
{
	...
	{
		redirect('reseller/customers/customer_acl_nodes/'.$customer_id.''); 
	}
	...
	$data['main_menu']	    =	'';
	$data['sub_menu']	    =	'';
	$data['main_content']	=	'reseller/customers/edit_acl_node_view';
    $data['dont_show_this'] = 1;
	$this->load->view('default/template',$data);
}
...
function sip_access($customer_id)
{
	...
	$data['main_menu']	    =	'';
	$data['sub_menu']	    =	'';
	$data['main_content']	=	'reseller/customers/sip_customer_view';
    $data['dont_show_this'] = 1;
	$this->load->view('default/template',$data);
}
...
function customer_cdr($customer_id)
{
	...
	$this->load->library('pagination');
	$config['per_page'] = '20';
	$config['base_url'] = base_url().'reseller/customers/customer_cdr/'.$customer_id.'/?searchFilter='.$search.'&filter_date_from='.$filter_date_from.'&filter_date_to='.$filter_date_to.'&filter_phonenum='.$filter_phonenum.'&filter_call_type='.$filter_call_type.'&filter_display_results='.$filter_display_results.'&filter_quick='.$filter_quick.'&duration_from='.$duration_from.'&duration_to='.$duration_to.'&filter_sort='.$filter_sort.'';
	$config['page_query_string'] = TRUE;
	...
	$data['count'] = $this->customer_model->customer_cdr_count($customer_id, $filter_date_from, $filter_date_to, $filter_phonenum, $filter_call_type, $duration_from, $duration_to);
	$config['total_rows'] = $data['count'];
	...
	$data['cdr']            =   $this->customer_model->customer_cdr($config['per_page'],$config['uri_segment'], $customer_id, $filter_date_from, $filter_date_to, $filter_phonenum, $filter_call_type, $duration_from, $duration_to, $filter_sort);
	...
	$data['main_menu']	    =	'';
	$data['sub_menu']	    =	'';
	$data['main_content']	=	'reseller/customers/cdr_customer_view';
    $data['dont_show_this'] = 1;
	$this->load->view('default/template',$data);
}
...
function manage_balance($customer_id)
{
	...
	$data['main_menu']	    =	'';
	$data['sub_menu']	    =	'';
	$data['main_content']	=	'reseller/customers/balance_customer_view';
    $data['dont_show_this'] = 1;
	$this->load->view('default/template',$data);
}
...
function my_account()
{
	...
	$data['main_menu']	    =	'default/main_menu/reseller_main_menu';
	$data['sub_menu']	    =	'';
	$data['main_content']	=	'reseller/my_account';
	$this->load->view('default/template',$data);
}
