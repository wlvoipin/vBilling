...
class Settings extends CI_Controller {
	...
	{
		parent::__construct();
		$this->load->model('reseller/settings_model');
	...
	function index()
	{
		...
		$data['sub_menu']	    =	'default/sub_menu/reseller/settings_sub_menu';
		$data['main_content']	=	'reseller/settings/settings_view';
