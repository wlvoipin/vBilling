...
<table cellspacing="0" cellpadding="0" border="0" align="center" width="100%">
  <tbody>
    <tr>
      ...
      <td width="825" class="heading"> GENERAL SETTINGS </td>
    ...
    <?php
            $sql = "SELECT * FROM settings WHERE customer_id = '0'";
            ...
            if($query->num_rows() > 0)
            {
				...
				$enable_rate_limits = $row->enable_rate_limits;
            }
        ?>
    <tr>
      <td align="center" height="20" colspan="3"><form enctype="multipart/form-data"  method="post" action="<?php echo base_url();?>settings/update_settings" name="updateSettings" id="updateSettings">
          <table cellspacing="3" cellpadding="2" border="0" width="95%" class="search_col">
            <tbody>
              ...
              <tr>
                <td align="right" width="45%"><span class="optional"></span> Enable Rate Limits:</td>
                <td align="left" width="55%"><input type="checkbox" id="enable_rate_limits" value="1" name="enable_rate_limits" <?php if($enable_rate_limits == '1'){ echo "checked"; }?>/></td>
              </tr>
              <tr>
                <td align="right">&nbsp;</td>
    ...
    <tr>
      <td width="21" height="35"></td>
      <td width="825" class="heading"> INVOICE SETTINGS </td>
      <td width="178"><table cellspacing="0" cellpadding="0" width="170" height="42" class="search_col">
          <tbody>
            <tr>
              <td align="center" width="53" valign="bottom">&nbsp;</td>
    ...
    <tr>
      <td background="http://localhost/vb2/htdocs/assets/images/line.png" height="7" colspan="3"></td>
    </tr>
    <tr>
      <td height="10"></td>
      <td></td>
    ...
    <tr>
      <td align="center" height="20" colspan="3"><form enctype="multipart/form-data"  method="post" action="<?php echo base_url();?>settings/update_inv_settings" name="updateInvSettings" id="updateInvSettings">
          <table cellspacing="3" cellpadding="2" border="0" width="95%" class="search_col">
            <tbody>
              <tr>
                <td align="right">&nbsp;</td>
                <td align="left"><input type="checkbox" id="same_logo" value="1" name="same_logo" <?php if($company_logo_as_invoice_logo == '1'){ echo "checked"; }?>/>
                  &nbsp;Use Site Logo For Invoices</td>
              </tr>
              ...
              <tr>
                ...
                <td align="left" width="55%"><textarea name="inv_footer" id="inv_footer" rows="10" cols="50"><?php echo $invoice_terms;?></textarea>
              </tr>
              <tr>
                <td align="right" width="45%">CDR Invoice Fields To Show (Optional):</td>
                <td align="left" width="55%"><select size="5" multiple="multiple" name="extra_cdr[]" id="extra_cdr" class="field multiselect">
                    <?php 
...
<script type="text/javascript">
    ...
    $.blockUI({ css: { 
				...
				var enable_rate_limits = $('#enable_rate_limits').val()
