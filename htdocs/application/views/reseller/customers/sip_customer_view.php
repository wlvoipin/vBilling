                ...
                <thead>
                    ...
                    <?php if(customer_any_cell($customer_id, 'parent_id') == $this->session->userdata('customer_id')){?>
                        <tr class="main_text" style="background:none;">
                            <td align="right" colspan="7"><a href="<?php echo base_url();?>reseller/customers/new_sip_access/<?php echo $customer_id;?>">NEW SIP ACCESS</a></td>
                        </tr>
                    <?php } ?>
                              
                    <tr class="bottom_link">
                        <td width="13%" align="center">Username</td>
                        <td width="13%" align="center">Password</td>
                        <td width="13%" align="center">CID</td>
                        <td width="13%" align="center">Domain</td>
                        <td width="13%" align="center">Sofia Profile</td>
                        <td width="13%" align="center">Delete</td>
                        <td width="13%" align="center">Enable/Disable</td>
                    </tr>
            ...
            $( "#dialog-confirm-delete" ).dialog({
                    ...
                    buttons: {
                        "Continue": function() {
                            ...
                            $.ajax({
                                type: "POST",
                                url: base_url+"reseller/customers/delete_sip_access",
                                data: data,
...
<script type="text/javascript">
                ...
                $( "#dialog-confirm-enable" ).dialog({
                    ...
                    buttons: {
                        "Continue": function() {
                            ...
                            $.ajax({
                                type: "POST",
                                url: base_url+"reseller/customers/enable_disable_sip_access",
                                data: data,
                                success: function(html){
        ...
        $('.reset_pass').live('click', function(){
            ...
            $.ajax({
                type: "POST",
                url: base_url+"reseller/customers/reset_sip_password",
                data: data,
                success: function(html){
                        $('.error').hide();
