...
<div style="text-align:center;padding:10px">
    ...
    <form method="get" action="<?php echo base_url();?>reseller/billing/invoices/" id="filterForm"> 
...
<div class="info">
        ...
        * An invoice will be generated from last generated invoice to current date starting from 12:00:00 am<br/>
        * You can only generate invoice for those customers/resellers which were created by you.
    ...
    <div style="text-align:center;padding:10px">
        ...
        <form method="post" action="<?php echo base_url();?>reseller/billing/generate_manual_invoice/" id="newInvForm"> 
                    ...
                    <tr>
                        <td>
                            <select name="new_inv_customer" id="new_inv_customer">
                                <?php echo customer_drop_down_generate_invoice_reseller();?>
                            </select>
                        </td>
...
<table width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <?php if($invoices->num_rows() > 0) {?>
                        ...
                        ?>
                            <tr class="main_text">
                                ...
                                <td align="center"><?php echo anchor_popup('reseller/customers/edit_customer/'.$row->customer_id.'', customer_full_name($row->customer_id), $atts); ?></td>
    ...
    $(document).ready(function (){
        ...
        $('div.mcdropdown input[type="text"]').css("width","132px");
    });
    //-->
    </script>
    <!--************************END*************************-->
