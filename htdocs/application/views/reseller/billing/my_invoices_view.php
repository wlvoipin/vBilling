...
<div style="text-align:center;padding:10px">
    ...
    <form method="get" action="<?php echo base_url();?>billing/invoices/" id="filterForm"> 
        <table width="673" cellspacing="0" cellpadding="0" border="0" id="filter_table">
        ...
        <tbody><tr>
            <td>
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <?php $my_name = customer_full_name($this->session->userdata('customer_id'));?>
                    <?php if($invoices->num_rows() > 0) {?>
                        ...
                        ?>
                            <tr class="main_text">
                                ...
                                <td align="center"><?php echo $my_name; ?></td>
