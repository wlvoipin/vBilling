...
<div style="text-align:center;padding:10px">
    ...
    <form method="get" action="<?php echo base_url();?>cdr/my_cdr/" id="filterForm"> 
...
<table width="100%" cellpadding="0" cellspacing="0">
        <tbody><tr>
            <td>
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <?php } else { echo '<tr><td align="center" style="color:red;" colspan="5">No Results Found</td></tr>'; } ?>
                    </tbody>
                </table>
            </td>
        </tr>
    ...
    <script type="text/javascript">
        ...
        $('#searchFilter').click(function(){
            $('#filterForm').attr('action', ''+base_url+'reseller/cdr/my_cdr/');
        });
    </script>
