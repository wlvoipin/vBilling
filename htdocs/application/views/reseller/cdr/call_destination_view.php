...
<div style="text-align:center;padding:10px">
    ...
    <form method="get" action="<?php echo base_url();?>reseller/cdr/call_destination" > 
        <table width="100%" cellspacing="0" cellpadding="0" border="0" id="filter_table">
                ...
                <tr>
                    ...
                    <td>
                        <select name="filter_countries" id="filter_countries">
                    ...
                    <?php if($countries->num_rows() > 0) {?>
                        ...
                        <?php foreach ($countries->result() as $row): ?>
                            <tr class="main_text">
                                ...
                                <?php 
                                    $total_duration = $this->cdr_model->get_country_total_mins($row->id, $filter_date_from, $filter_date_to, $filter_contents);
                                ...
                                <td align="center"><?php echo $this->cdr_model->get_country_total_calls($row->id, $filter_date_from, $filter_date_to, $filter_contents); ?></td>
                                
                                <!--**************GET TOTAL SELL COST FOR CUSTOMER ******************-->
                                <td align="center"><?php echo round($this->cdr_model->get_country_total_sell_cost($row->id, $filter_date_from, $filter_date_to, $filter_contents), 4); ?></td>
                                
                                <!--**************GET TOTAL BUY COST FOR CUSTOMER ******************-->
                                <td align="center"><?php echo round($this->cdr_model->get_country_total_buy_cost($row->id, $filter_date_from, $filter_date_to, $filter_contents), 4); ?></td>
