...
<div style="text-align:center;padding:10px">
    ...
    <form method="get" action="<?php echo base_url();?>reseller/groups/list_rates/" id="global_search"> 
            ...
            <td>
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr class="bottom_link">
                        ...
                        <td width="8%" align="center">Sell Init</td>
                        <td width="8%" align="center">Buy Rate</td>
                        <td width="8%" align="center">Buy Init</td>
                        <td width="8%" align="center">Intrastate Rate</td>
                        <td width="8%" align="center">Intralata Rate</td>
                    </tr>
                    ...
                    <?php if($rate->num_rows() > 0) {?>
                        ...
                        <?php foreach ($rate->result() as $row): ?>
                            <tr class="main_text">
                                ...
                                <td align="center"><?php echo $row->intrastate_rate; ?></td>
                                <td align="center"><?php echo $row->intralata_rate; ?></td>
