        ...
        <form enctype="multipart/form-data"  method="post" action="" name="addGroup" id="addGroup">
            ...
            <table cellspacing="0" cellpadding="0" border="0" width="95%" class="search_col">
                ...
                <thead>
                    ...
                    <tr><td colspan="9" id="shadowDiv" style="height:5px;margin-top:-1px"></td></tr>
                </thead>
                ...
                <tbody id="dynamic">
                    ...
                    ?>
                        <tr class="main_text" <?php echo $bg;?>>
                            <td align="center"><a href="<?php echo base_url();?>reseller/groups/update_rate/<?php echo $rowRate->id;?>/<?php echo $rate_group_id;?>"><?php echo $rowRate->digits; ?></a></td>
                        ...
                        <tr style="height:5px;"><td colspan="9" id="shadowDiv" style="height:5px;margin-top:0px;background-color:#fff"></td></tr>
                    <?php } ?>
                    <?php } else { ?>
                        
                        <tr class="main_text"><td align="center" colspan="9">No Records Found</td></tr>
                    <?php } ?>
                </tbody>
            </table>
       ...
       if(text != '')
       {
       ...
       else
        {
           var form = $('#addGroup').serialize();
            $.ajax({
                    type: "POST",
					url: base_url+"reseller/groups/edit_group_db",
					data: form,
                ...
                $( "#dialog-confirm-enable" ).dialog({
                    ...
                    buttons: {
                        "Continue": function() {
                            ...
                            $.ajax({
                                type: "POST",
                                url: base_url+"reseller/groups/enable_disable_rate",
                                data: data,
                                success: function(html){
            ...
            $( "#dialog-confirm-delete" ).dialog({
                    ...
                    buttons: {
                        "Continue": function() {
                            ...
                            $.ajax({
                                type: "POST",
                                url: base_url+"reseller/groups/delete_group_rate",
                                data: data,
                                success: function(html){
