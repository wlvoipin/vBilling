...
<div style="text-align:center;padding:10px">
    ...
    <form method="get" action="<?php echo base_url();?>reseller/groups/" > 
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <?php if($groups->num_rows() > 0) {?>
                        ...
                        <?php foreach ($groups->result() as $row): ?>
                            <tr class="main_text">
                                <td align="center"><a href="<?php echo base_url();?>reseller/groups/update_group/<?php echo $row->id;?>"><?php echo $row->group_name; ?></a></td>
                ...
                $( "#dialog-confirm-enable" ).dialog({
                    ...
                    buttons: {
                        "Continue": function() {
                            ...
                            $.ajax({
                                type: "POST",
                                url: base_url+"reseller/groups/enable_disable_group",
                                data: data,
            ...
            $( "#dialog-confirm-delete" ).dialog({
                    ...
                    buttons: {
                        "Continue": function() {
                            ...
                            $.ajax({
                                type: "POST",
                                url: base_url+"reseller/groups/check_group_in_use",
                                data: data,
                                success: function(html){
                                    if(html == 'in_use')
                                    {
                                        ...
                                        $( "#dialog-confirm-again" ).dialog({
                                                                        ...
                                                                        buttons: {
                                                                            "Continue": function() {
                                                                                ...
                                                                                $.ajax({
                                                                                    type: "POST",
                                                                                    url: base_url+"reseller/groups/delete_group",
                                                                                    data: data,
                                                                                    success: function(html){
