...
<table cellspacing="0" cellpadding="0" border="0" align="center" width="100%">
  <tbody>
    <tr>
      ...
      <td width="825" class="heading"> Update Customer </td>
          ...
          <table cellspacing="3" cellpadding="2" border="0" width="95%" class="search_col">
            ...
            <tbody>
              <tr style="display:none;">
                ...
                <td align="left"><select class="textfield" name="type" id="type">
                    <option value="0" <?php if($row->reseller_level == '0'){ echo "selected";} ?>>Normal Customer</option>
                    <option value="3" <?php if($row->reseller_level == '3'){ echo "selected";} ?>>Reseller (Level- 3)</option>
              ...
              <tr>
                ...
                <td align="left"><input type="text" value="<?php echo $row->customer_company;?>" name="companyname" id="companyname" maxlength="50" class="textfield"></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td align="left"><select  name="account_type" id="account_type" class="textfield">
              ...
              <tr>
                ...
                <td align="left"><select  name="billing_cycle" id="billing_cycle" class="textfield">
              ...
              <tr>
                ...
                <td align="left"><input type="text" value="<?php echo $row->customer_city;?>" name="city" id="city" maxlength="20" class="textfield"></td>
              </tr>
              <tr>
                <td align="right"><span class="required">*</span> State:</td>
                <td align="left"><input type="text" value="<?php echo $row->customer_state;?>" name="state" id="state" maxlength="20" class="textfield"></td>
              </tr>
              <tr>
              ...
              <tr>
                <td align="right">&nbsp;</td>
                <td align="left"><input type="checkbox" id="cdr_check" value="1" name="cdr_check" <?php if($row->customer_send_cdr == '1'){ echo 'checked="checked"'; }?>>
                  &nbsp;Attach CDR With Email</td>
              </tr>
              <tr>
                <td align="right">&nbsp;</td>
                <td align="left"><input type="checkbox" id="same_check" value="1" name="same_check">
                ...
                <td align="center" colspan="2"><table cellspacing="3" cellpadding="2" border="0" width="100%" class="search_col">
                    <tbody>
                      <tr>
                        ...
                        <td align="left" width="55%"><input type="text" value="<?php echo $row->customer_billing_email;?>" name="cdr_email" id="cdr_email" maxlength="50" class="textfield"></td>
                      </tr>
                    </tbody>
                  </table></td>
              </tr>
                ...
                <td align="center" colspan="2"><table cellspacing="3" cellpadding="2" border="0" width="100%" class="search_col">
                    <tbody>
                      <tr>
                        ...
                        <td align="left" width="55%"><input name="username" type="text" class="textfield" id="username" value="<?php echo $rowAccess->username;?>" maxlength="20"></td>
                      ...
                      <tr>
                        ...
                        <td align="left"><input  name="confirmpassword" type="password" class="textfield" id="confirmpassword" maxlength="20"></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td align="right">&nbsp;</td>
                        <td align="left"><input type="checkbox" value="Y" name="email_check" id="email_check" readonly>
              ...
              <tr>
                <td align="right">&nbsp;</td>
                <td align="left"><input type="checkbox" id="access_chk" value="Y" name="access_chk">
                  &nbsp;Allow Userpanel Access</td>
              </tr>
              <tr id="userpass" style="display:none">
                <td align="center" colspan="2"><table cellspacing="3" cellpadding="2" border="0" width="100%" class="search_col">
                    <tbody>
                      <tr>
                        <td align="right" width="45%"><span class="required">*</span> Username:</td>
                        <td align="left" width="55%"><input name="username" type="text" class="textfield" id="username" value="" maxlength="20"></td>
                      </tr>
                      <tr>
                        <td align="right"><span class="required">*</span> Password:</td>
                        <td align="left"><input name="password" type="password" class="textfield" id="password" value="" maxlength="20"></td>
                      </tr>
                      <tr>
                        <td align="right"><span class="required">*</span>Confirm Password:</td>
...
$('#rate_limit_check').click(function(){
    if ($(this).is(':checked'))
    {
        $('#customer_limits_check').show();
    }
    else
    {
        $('#customer_limits_check').hide();
    }
});
...
$('#addCust').submit(function(){
    ...
    $.blockUI({ css: { 
				...
				var group                    = $('#group').val();
				var rate_limit_check         = $('#rate_limit_check').val();
				var customer_low_rate_limit  = $('#customer_low_rate_limit').val();
				var customer_high_rate_limit = $('#customer_high_rate_limit').val();
        ...
        else
        {
           var form = $('#addCust').serialize();
            $.ajax({
                    type: "POST",
					url: base_url+"customers/update_customer_db",
					data: form,
                    success: function(html){
...
<?php } else { ?>
<tr>
  <td align="center" height="20" colspan="3"><table cellspacing="3" cellpadding="2" border="0" width="95%" class="search_col">
      <tbody>
        <tr>
        ...
        <tr>
          ...
          <td align="left"><?php if($row->customer_prepaid == 1){ echo "Prepaid";} else { echo "Postpaid"; }?></td>
        </tr>
        <tr class="account_type_dependent" <?php if($row->customer_prepaid == 1){ echo 'style="display:none;"';}?> >
