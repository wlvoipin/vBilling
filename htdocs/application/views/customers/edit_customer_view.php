        ...
        <form enctype="multipart/form-data"  method="post" action="" name="addCust" id="addCust">
            <table cellspacing="3" cellpadding="2" border="0" width="95%" class="search_col">
                ...
                <tr>
                    ...
                    <td align="left"><input type="text" value="<?php echo $row->customer_zip;?>" name="zipcode" id="zipcode" maxlength="5" class="textfield"></td>
                </tr>
                <tr>
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <select  name="sip_ip" id="sip_ip" class="textfield">
                                        <?php echo get_all_sip_ips(customer_access_any_cell($customer_id, 'domain'), customer_access_any_cell($customer_id, 'domain_sofia_id')); ?>
                                    </select>
                                </td>
                            </tr>
                            <tr>
...
$('#addCust').submit(function(){
    ...
    $.blockUI({ css: { 
        ...
        if(firstname == '' || lastname == '' || maxcalls == '' || address == '' || city == '' || state == '' || zipcode == '' || country == '' || group == '' || tot_acl_nodes == '' || tot_sip_acc == '' || sip_ip == '' || billing_cycle == '')
        {
            required_error = 1;
        }
