    ...
    $.blockUI({ css: { 
        ...
        else
        {
           var form = $('#addSipAccess').serialize();
            $.ajax({
                    type: "POST",
					url: base_url+"customers/update_sip_access",
					data: form,
                    success: function(html){
                        if(html == 'username_not_available')
                        {
                            $('.success').hide();
                            $('.error').html('Username already in use. Try a different username.');
                            $('.error').fadeOut();
                            $('.error').fadeIn();
                            document.getElementById('err_div').scrollIntoView();
                            $.unblockUI();
                        ...
                        {
                            $('.error').hide();
                            $('.success').html("SIP Credentials Updated Successfully.");
                            $('.success').fadeOut();
                            $('.success').fadeIn();
