...
<div style="text-align:center;padding:10px">
  <div class="button white">
    ...
    <form method="get" action="<?php echo base_url();?>groups/localization_groups/" >
      <table width="729" cellspacing="0" cellpadding="0" border="0" id="filter_table">
        ...
        <tr>
          <td><select name="filter_groups" id="filter_groups" style="width:150px;">
              <?php echo show_localization_group_select_box($filter_groups);?>
            </select></td>
          ...
          <td><select name="filter_sort" id="filter_sort" style="width:124px;">
              <option value="">Select</option>
              <option value="name_asc" <?php if($filter_sort == 'name_asc'){ echo "selected";}?>>Localization Group - ASC</option>
              <option value="name_dec" <?php if($filter_sort == 'name_dec'){ echo "selected";}?>>Localization Group - DESC</option>
            </select></td>
        </tr>
      </table>
    </form>
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tbody>
          <tr class="bottom_link">
            <td width="20%" align="center">Localization Group Name</td>
          ...
          <tr class="main_text">
            ...
            <td align="center"><a href="<?php echo base_url();?>groups/update_localization_group/<?php echo $row->id;?>"><?php echo $row->name; ?></a></td>
            <?php 
...
<script type="text/javascript">
                ...
                $( "#dialog-confirm-enable" ).dialog({
                    ...
                    buttons: {
                        "Continue": function() {
                            ...
                            $.ajax({
                                type: "POST",
                                url: base_url+"groups/enable_disable_localization_group",
                                data: data,
        ...
        $('.delete_group').live('click', function(){
            ...
            $( "#dialog-confirm-delete" ).dialog({
                    ...
                    buttons: {
                        "Continue": function() {
                            var data  = 'localization_id='+id;
                            $.ajax({
                                type: "POST",
                                url: base_url+"groups/check_localization_group_in_use",
                                data: data,
                                success: function(html){
                                    if(html == 'in_use')
                                    {
                                        ...
                                        $( "#dialog-confirm-again" ).dialog({
                                                                        ...
                                                                        buttons: {
                                                                            "Continue": function() {
                                                                                ...
                                                                                $.ajax({
                                                                                    type: "POST",
                                                                                    url: base_url+"groups/delete_localization_group",
                                                                                    data: data,
                                                                                    success: function(html){
                                                                                        $( "#dialog-confirm-again" ).dialog( "close" );
                                                                                        $( "#dialog-confirm-delete" ).dialog( "close" );
                                                                                        curr_row.fadeOut();
                                                                                        $('.success').html("Group & Its Associated  Table Deleted Successfully.");
                                                                                        $('.success').fadeOut();
                                                                                        $('.success').fadeIn();
                                                                                        document.getElementById('success_div').scrollIntoView();
                                                                                    }
