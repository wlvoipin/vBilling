...
<div id="subMenu">
        <ul>
            <li><a href="<?php echo base_url();?>groups/" <?php if($sub_selected == 'list_groups') { echo 'class="sub_selected"' ;}?>>List Rate Groups</a></li>
            <li><a href="<?php echo base_url();?>groups/new_group" <?php if($sub_selected == 'new_group') { echo 'class="sub_selected"' ;}?>>New Rate Group</a></li>
