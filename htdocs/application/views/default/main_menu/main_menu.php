<div class="menu">
        <ul>
            ...
            <li <?php if($selected == "groups") { echo 'class="menu-selected"';} ?>><a class="center_hassub" href="<?php echo base_url();?>groups/">Groups</a></li>
            ...
            <li <?php if($selected == "freeswitch") { echo 'class="menu-selected"';} ?>><a class="center_hassub" href="<?php echo base_url();?>freeswitch/">Free Switch</a></li>
