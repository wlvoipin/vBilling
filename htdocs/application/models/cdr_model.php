...
class Cdr_model extends CI_Model {
	...
	function get_all_customers($num, $offset, $filter_customers = '')
	{
		if($offset == ''){$offset='0';}
	...
	function get_all_customers_count($filter_customers = '')
	{
		$where = '';
	...
	function get_all_countries($num, $offset, $filter_countries = '', $filter_date_from, $filter_date_to)
	{
		if($offset == ''){$offset='0';}

		$where = '';
		$where .= "WHERE (hangup_cause = 'NORMAL_CLEARING' || hangup_cause = 'ALLOTTED_TIMEOUT') AND billsec > 0 ";
	...
	function get_all_countries_count($filter_countries = '', $filter_date_from, $filter_date_to)
	{
		$where = '';
		$where .= "WHERE (hangup_cause = 'NORMAL_CLEARING' || hangup_cause = 'ALLOTTED_TIMEOUT') AND billsec > 0 ";
